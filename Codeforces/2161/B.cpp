...
void solve() {
    int n;
    cin >> n;
    map<int, int> downleft, downright;
    char grid[n][n];
    int cnt = 0;
    for (int i = 0; i < n; ++i) {
        for (int j = 0; j < n; ++j) {
    ...
    if (downleft.size() < 2 || downright.size() < 2) {
        cout << "YES\n";
        return;
    }
    if (downleft.size() == 2 && (*downleft.begin()).first + 1 == (*downleft.rbegin()).first) {
        cout << "YES\n";
        return;
    }
    if (downright.size() == 2 && (*downright.begin()).first + 1 == (*downright.rbegin()).first) {
        cout << "YES\n";
        return;
    }
    cout << "NO\n";
