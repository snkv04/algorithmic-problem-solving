...
public class ArrayColoring {
    public static void main(String[] args) throws IOException {
        /*
         * Regardless of how many elements are in each of the two sets, if we assume that each set
         * has at least one element, then two sets that each have an odd number of elements will
         * have a total sum of number of elements that is even, and two sets that each have an even
         * number of elements will have a total number of elements that is also even. So, we can
         * just check if the total sum is equal to an even number, because we can just pick any
         * random element to be in one set, and the sum of all the remaining elements that belong
         * to the other set will have the same parity. In other words, the condition of ensuring
         * that both sets have the same parity is equivalent to ensuring that the total sum of 
         * elements is even (which also takes into consideration that there are at least two
         * elements in the array in the first place). If the total sum is odd, then the parity
         * of the sums of the two sets must be different.
         */
