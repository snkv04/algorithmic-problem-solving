...
public class PlusMinusPermutation {
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            long y = Integer.parseInt(line[2]);
            long lcm = x * y / gcd(x, y);
            long cycles = n / lcm;
            long xAlone = (lcm/x - 1) * cycles + (n - lcm*cycles)/x;
            long yAlone = (lcm/y - 1) * cycles + (n - lcm*cycles)/y;
            long l = n-xAlone+1, r = n;
            long score = r*(r+1)/2 - l*(l-1)/2;
            score -= yAlone*(yAlone+1)/2;
            pw.println(score);
        }
