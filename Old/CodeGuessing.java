...
public class CodeGuessing {
    ...
    static void solve() throws IOException {
        ...
        int p = Integer.parseInt(asdf[0]), q = Integer.parseInt(asdf[1]);
        String order = br.readLine();
        if (order.equals("AABB")) {
            if (q==7) pw.println("8 9");
            else n1();
        } else if (order.equals("ABAB")) {
            if (p==6&&q==8) pw.println("7 9");
            else n1();
        } else if (order.equals("ABBA")) {
            if (p == q-3) pw.println((p+1)+" "+(p+2));
            else n1();
        } else if (order.equals("BAAB")) {
            if (p==2&&q==8) pw.println("1 9");
            else n1();
        } else if (order.equals("BABA")) {
            if (p==2&&q==4) pw.println("1 3");
            else n1();
        } else {
            if (p==3) pw.println("1 2");
            else n1();
        }
    }
