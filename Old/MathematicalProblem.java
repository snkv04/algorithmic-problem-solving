...
public class MathematicalProblem {
    ...
    static HashMap<Integer, ArrayList<String>> answers;
    ...
    public static void main(String[] args) throws IOException {
        ...
        a.add(String.valueOf(new char[] {'1'}));
        answers.put(1, a);
        ArrayList<String> b = new ArrayList<>();
        b.add(String.valueOf(new char[] {'1', '6', '9'}));
        b.add(String.valueOf(new char[] {'1', '9', '6'}));
        b.add(String.valueOf(new char[] {'9', '6', '1'}));
        answers.put(3, b);
        for (int i = 5; i <= 99; i += 2) {
            ArrayList<String> c = new ArrayList<>();
            for (String s : b) {
                char[] copy = Arrays.copyOf(s.toCharArray(), i);
                copy[i-2] = '0';
                copy[i-1] = '0';
                c.add(String.valueOf(copy));
            }
            char[] arr = new char[i]; Arrays.fill(arr, '0');
            arr[0] = '1'; arr[i/2] = '6'; arr[i-1] = '9';
            c.add(String.valueOf(arr));
            arr[0] = '9'; arr[i/2] = '6'; arr[i-1] = '1';
            c.add(String.valueOf(arr));
            answers.put(i, c);
            b = c;
        }
    ...
    static void solve() throws IOException {
        ...
        for (String s : answers.get(n)) pw.println(s);
    }
