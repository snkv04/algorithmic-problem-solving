...
public class Tetrahedron {
    public static void main(String[] args) throws IOException {
        ...
        long memo0=1, memo1=0;
        int mod = (int)1e9+7;
        for (int i = 1; i <= n; i++) {
            long memo1Updated = memo0 + 2*memo1;
            long memo0Updated = 3 * memo1;
            memo1 = memo1Updated%mod;
            memo0 = memo0Updated%mod;
        }
        pw.println(memo0);
        ...
        // else if (n==2) pw.println(m2);
        // else if (n==3) pw.println(m3);
        // else if (n%2==0) {
        //     for (int i = 4; i <= n; i+=2) {
        //         m2 = 9*m2-6;
        //         m2%=mod;
