...
public class LetterBalloons {
    ...
    static void solve() throws IOException {
        /*
         * read in input
         * construct array of the letters
         * go through all possible subsets of teams
         * for each subset:
         *      if they're able to each get their letters, then set ans to max of itself and the size fo the subset
         *      to check if they all get their letters, have a boolean array of the letters, and go through each
         *          letter in a team
         */
        int[] input = Arrays.stream(br.readLine().split(" ")).mapToInt(Integer::parseInt).toArray();
        int p = input[0], t = input[1];
        String[] teams = new String[t]; for (int i = 0; i < t; i++) teams[i] = br.readLine();
        int ans = 0;
        for (int i = 0; i < (1<<t); i++) {
