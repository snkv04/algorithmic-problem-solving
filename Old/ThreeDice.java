...
public class ThreeDice {
    ...
    public static void main(String[] args) throws IOException {
        ...
        words = new TreeSet<char[]>(Comparator.comparing(o -> String.valueOf(o)));
        for (int i = 1; i <= n; i++) {
        ...
        // for (char[] element : words) pw.println(element);
        TreeSet<Character>[] dice = new TreeSet[3]; for (int i = 0; i <= 2; i++) dice[i] = new TreeSet<>();
        for (char[] word : words) {
