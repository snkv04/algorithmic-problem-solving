...
public class DataStructuresFan {
    public static void main(String[] args) throws IOException {
        ...
        while (t-->0) {
            ...
            int[] xorprefsums = new int[n+1];
            int xorSum0 = 0, xorSum1 = 0;
            for (int i = 1; i <= n; i++) {
                xorprefsums[i] = xorprefsums[i-1] ^ a[i-1];
                if (s[i-1]=='0') xorSum0 = xorSum0 ^ a[i-1];
                else xorSum1 = xorSum1 ^ a[i-1];
            }
            ...
            for (int i = 1; i <= q; i++) {
                ...
                if (line[0].equals("1")) {
                    ...
                    xorSum0 = xorSum0 ^ xorprefsums[r] ^ xorprefsums[l-1];
                    xorSum1 = xorSum1 ^ xorprefsums[r] ^ xorprefsums[l-1];
                } else {
                    if (line[1].equals("0")) pw.print(xorSum0 + " ");
                    else pw.print(xorSum1 + " ");
                }
            }
            pw.println();
        }
