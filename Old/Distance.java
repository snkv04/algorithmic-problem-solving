...
public class Distance {
    ...
    static void solve() throws IOException {
        ...
        PriorityQueue<Point> pq = new PriorityQueue<>(Comparator.comparingInt(o -> o.i)),
            pq2 = new PriorityQueue<>(Comparator.comparingInt(o -> o.j));
        while (n-->0) {
