...
public class InLove {
    ...
    static void solve() throws IOException {
        ...
        Multiset lefts = new Multiset(), rights = new Multiset();
        while (q-->0) {
            String[] split = br.readLine().split(" ");
            int l = Integer.parseInt(split[1]), r = Integer.parseInt(split[2]);
            if (split[0].equals("+")) {
                lefts.add(l);
                rights.add(r);
            } else {
            ...
            pw.println((!lefts.mset.isEmpty() && lefts.mset.lastKey() > rights.mset.firstKey()) ? "YES" : "NO");
        }
    }
