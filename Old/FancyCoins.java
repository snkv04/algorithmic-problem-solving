...
public class FancyCoins {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-->0) {
            ...
            a1 = Integer.parseInt(line[2]);
            ak = Integer.parseInt(line[3]);
    ...
    static boolean check(long using) {
        // NOT A STRICTLY MONOTONIC FUCNTION (i think), FIX IT
        long remaining = m - ak*k + (using-1)*k;
        return (a1 >= remaining) || (remaining - k <= a1);
    }
