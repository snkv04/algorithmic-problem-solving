...
public class LauraAndOperations {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-->0) {
            ...
            // pw.print(((b+c)%2==0)?"1 ":"0 ");
            // pw.print(((a+c)%2==0)?"1 ":"0 ");
            // pw.println(((b+a)%2==0)?"1":"0");
            for (int i = 0; i <= 2; i++) {
                int other1 = Integer.parseInt(line[(i+1)%3]);
                int other2 = Integer.parseInt(line[(i+2)%3]);
                if ((other1%2)==(other2%2)) {
                    // int diff = Math.abs(other1-other2)/2;
                    int num = Integer.parseInt(line[i]);
                    if (num + Math.min(other1, other2) >= 1) {
                        pw.print(1);
                    } else {
                        pw.print(0);
                    }
