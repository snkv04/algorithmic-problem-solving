...
public class LoadBalancing {
    ...
    public static void main(String[] args) throws IOException {
        ...
        pw = new PrintWriter(new BufferedWriter(new FileWriter("balancing.out")));
    ...
    static void solve() throws IOException {
        ...
        int n = Integer.parseInt(split[0]), b = Integer.parseInt(split[1]);
        ...
        for (int xBound : xs) {
            for (int yBound : ys) {
                ...
                ans = Math.min(ans, Math.max(Math.max(tl, tr), Math.max(bl, br)));
            }
        }
        pw.println(ans);
    }
