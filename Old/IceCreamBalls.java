...
public class IceCreamBalls {
    public static void main(String[] args) throws IOException {
        ...
        while (t-->0) {
            ...
            long l=2, r=(long)3e9, ans=-1;
            while (l<=r) {
                long mid = (l+r)/2;
                // pw.println("testing "+mid);
                if ((mid*(mid-1)/2) <= n) {
                    ans = mid;
                    l = mid+1;
                    // pw.println("worked");
                    ...
                    r = mid-1;
                    // pw.println("didnt work");
                }
            }
            // pw.println("max ans is now "+ans);
            long product = ans*(ans-1)/2;
            ans += n-product;
            // pw.println("product was "+product);
            pw.println(ans);
        }
