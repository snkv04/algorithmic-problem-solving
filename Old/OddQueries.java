...
public class OddQueries {
    ...
    static void solve() throws IOException {
        ...
        while (q-->0) {
            ...
            long l = Integer.parseInt(line[0]), r = Integer.parseInt(line[1]), k = Integer.parseInt(line[2]);
            long sum = prefsums[n] - prefsums[(int)r] + prefsums[(int)l-1];
            sum += k * (r-l+1);
            pw.println(sum%2==1?"YES":"NO");
        }
    }
